...
public class ConsoleView implements ViewInterface {
    ...
    private String readValidDescription() {
        ...
        while (description == null || description.trim().isEmpty()) {
            description = readInput("Descripción: ");
            if (description.trim().isEmpty()) {
                System.out.print("La descripción no puede estar vacía. Intente de nuevo: ");
                description = null;
            } else if (!isValidDescription(description)) {
                System.out.print("La descripción solo debe contener letras y espacios. Intente de nuevo: ");
                description = null;
            }
        }
    ...
    private boolean isValidDescription(String description) {
        return description.matches("^[a-záéíóúñA-ZÁÉÍÓÚÑ\\s]+$");
    }
